export const tradearrow = function(d3_select, d3_functor, d3_pointer, d3_dispatch, accessor_trade, plot, plotMixin, svg_arrow) {  // Injected dependencies
    ...
    function tradearrow(g) {
      ...
      group.selection.selectAll('path.tradearrow')
        .on('mouseenter', function(event, data) {
          var nearest = findNearest(data, d3_pointer(event, this)[0]);
